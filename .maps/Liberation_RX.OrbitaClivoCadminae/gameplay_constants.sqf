GRLIB_map_modder = "DarkDemon";
GRLIB_save_key = "GREUH_LIBERATION_Orbita_Clivo_Cadminae_SAVEGAME_PSK";	// change this value if you want different savegames on different map
